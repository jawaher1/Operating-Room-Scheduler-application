 ...
 * @author chayma
 */
public class bloc4 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc4(){
        ...
        String query = "select * from bloc4";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
