 ...
 * @author jawaher
 */
public class bloc14 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc14(){
        ...
        String query = "select * from bloc14";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
