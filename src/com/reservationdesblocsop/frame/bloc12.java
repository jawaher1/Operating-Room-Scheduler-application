 ...
 * @author jawaher
 */
public class bloc12 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc12(){
        ...
        String query = "select * from bloc12";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
