 ...
 * @author chayma
 */
public class bloc9 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc9(){
        ...
        String query = "select * from bloc9";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
