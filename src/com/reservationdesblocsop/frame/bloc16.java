 ...
 * @author jawaher
 */
public class bloc16 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc16(){
        ...
        String query = "select * from bloc16";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc16.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
