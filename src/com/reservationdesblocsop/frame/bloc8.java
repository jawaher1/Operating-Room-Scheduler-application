 ...
 * @author chayma
 */
public class bloc8 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc8(){
        ...
        String query = "select * from bloc8";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
