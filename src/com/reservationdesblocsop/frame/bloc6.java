 ...
 * @author chayma
 */
public class bloc6 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc6(){
        ...
        String query = "select * from bloc6";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
