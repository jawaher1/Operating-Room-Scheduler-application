 ...
 * @author chayma
 */
public class bloc7 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc7(){
        ...
        String query = "select * from bloc7";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
