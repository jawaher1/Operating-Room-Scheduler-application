 ...
 * @author jawaher
 */
public class bloc10 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc10(){
        ...
        String query = "select * from bloc10";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
