 ...
 * @author chayma
 */
public class bloc2 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc2(){
        ...
        String query = "select * from bloc2";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
