 ...
 * @author jawaher
 */
public class bloc13 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc13(){
        ...
        String query = "select * from bloc13";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc13.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
