 ...
 * @author chayma
 */
public class bloc3 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc3(){
        ...
        String query = "select * from bloc3";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
