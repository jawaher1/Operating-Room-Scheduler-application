 ...
 * @author jawaher
 */
public class bloc11 extends javax.swing.JFrame {
int xMouse,yMouse;
    /**
    ...
    public ArrayList <Bloc> bloc11(){
        ...
        String query = "select * from bloc11";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bloc1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
